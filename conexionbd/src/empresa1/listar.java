...
void LISTAR(String VALOR){
    ...
    private void initComponents() {
        ...
        getContentPane().add(volver, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 320, -1, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/c.jpg"))); // NOI18N
